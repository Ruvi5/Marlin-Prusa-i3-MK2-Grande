 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 8000, 333 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 30, 0, -2.3 }
...
#define Z_PROBE_FEEDRATE_FAST  (3*60) // (mm/min)
 ...
 *
 *   M104 (hotend, no wait)  - temp = none,        low temp = stop timer
